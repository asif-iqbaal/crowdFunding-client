          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                { name: "Anand Roy", role: "Project Creator", quote: "I love discovering and supporting innovative projects. CrowdFund makes it easy and exciting to be part of something new.", avatar: "/placeholder.svg?height=100&width=100" },
                { name: "Abhinav Singh", role: "Project Creator", quote: "As a repeat creator, I can say that CrowdFund provides the best platform for bringing ideas to life. It's simply unmatched.", avatar: "/placeholder.svg?height=100&width=100" }
